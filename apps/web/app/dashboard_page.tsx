  ...
  return (
    <main style={{ maxWidth: 640, margin: "0 auto", padding: "28px 18px 60px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 26 }}>
        <div>
          <p style={{ fontSize: 10, letterSpacing: "4px", textTransform: "uppercase", color: "var(--dim)", marginBottom: 10 }}>
            Agent Studio v0.1
          </p>
          <h1 style={{ fontSize: 30, fontWeight: 800, color: "var(--bright)", lineHeight: 1.15, letterSpacing: "-0.5px" }}>
      ...
      <p style={{ fontSize: 13, color: "var(--text)", lineHeight: 1.7, marginBottom: 26 }}>
      ...
      <Link href="/run" style={{ ...card, display: "block", padding: "22px", marginBottom: 22, textDecoration: "none" }}>
        <p style={{ fontSize: 10, letterSpacing: "3px", textTransform: "uppercase", color: "var(--accent)", marginBottom: 10 }}>
          New project
        </p>
        <p style={{ fontSize: 19, fontWeight: 700, color: "var(--bright)", marginBottom: 8 }}>
          Run Research Agent
        </p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14, marginBottom: 22 }}>
        {[
          ...
          <div key={s.label} style={{ ...card, padding: "18px 14px" }}>
            <p style={{ fontSize: 9, letterSpacing: "2px", textTransform: "uppercase", color: "var(--dim)", marginBottom: 10 }}>
              {s.label}
            </p>
      ...
      <div style={{ ...card, padding: "22px 20px" }}>
        <p style={{ fontSize: 10, letterSpacing: "3px", textTransform: "uppercase", color: "var(--dim)", marginBottom: 20 }}>
          Pipeline (Phase 1)
        </p>
        {[
          ...
          <div key={step.n} style={{ display: "flex", alignItems: "flex-start", gap: 16, marginBottom: i === arr.length - 1 ? 0 : 18 }}>
            ...
            <div style={{ flex: 1, paddingTop: 2 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 4, flexWrap: "wrap" }}>
                <span style={{ fontSize: 14, fontWeight: 700, color: step.active ? "var(--bright)" : "var(--dim)" }}>
                  {step.name}
                </span>
                {step.active ? (
                  <span style={{
                ...
                <span style={{ fontSize: 10, color: "var(--dim)" }}>{step.time}</span>
              </div>
              <p style={{ fontSize: 12, color: "var(--dim)", lineHeight: 1.5 }}>{step.desc}</p>
            </div>
          </div>
        ))}
      </div>
